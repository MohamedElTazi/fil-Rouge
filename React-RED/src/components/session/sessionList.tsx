      ...
      {editSession && (
        <div className="modal">
          <div className="modal-content">
            ...
            <button onClick={handleSaveUpdate} className="mr-2 px-4 py-2 text-white bg-blue-500 rounded">Enregistrer</button>
            <button onClick={() => setEditSession(null)} className="px-4 py-2 text-white bg-gray-500 rounded">Annuler</button>
          </div>
        </div>
      )}
      ...
      {editSession && (
        <div className="modal">
          <div className="modal-content">
            ...
            <button onClick={handleSaveSlot} className="mr-2 px-4 py-2 text-white bg-blue-500 rounded">Enregistrer</button>
            <button onClick={() => setEditSession(null)} className="px-4 py-2 text-white bg-gray-500 rounded">Annuler</button>
          </div>
        </div>
      )}
